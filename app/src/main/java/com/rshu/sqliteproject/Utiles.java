...
//            "Spread with the spinach followed by the onions, then dot with the cheese and scatter with the olives, thyme and sunflower seeds. Bake for 15 mins until golden and the base is cooked through.";
    ...
    public static final String PIZZA_2_TITLE = "Margaritta cheese pizza";
    public static final String PIZZA_2_DESCRIPTION = "Make a potato, cheese, healthy and low-fat instead of ordering a takeaway. This easy recipe uses goat's cheese for tang while the onions give it sweetness..";
